...
function JobDetails({ job }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="border border-[#2e2e38] rounded p-4 space-y-3">
...
export default function ReviewTab({
  ...
  return (
    <div className="space-y-5">
      {/* Position selector */}
      <div className="bg-[#17171c] border border-[#2e2e38] rounded p-4">
      ...
      {job && (
        <>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            <div className="bg-[#17171c] border border-[#2e2e38] rounded p-5">
